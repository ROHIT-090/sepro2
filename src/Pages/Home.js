...
function Home() {
  return (
    ...
    </div><section className="home-sec" id="home">
      ...
      </section><section className="don-sec" id="donation">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="don-box">
                <img
                  ...
                  alt="img" />
                <h3>WaterSlide</h3>
                <Link to="/WaterSlide" className="btn1">
                  Know More
                </Link>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="don-box">
                <img
                  ...
                  alt="img" /><br />
                <h3>SeaWave</h3><br />
                <Link to="/Seawave" className="btn1">
                  Know More
                </Link><br />
              </div>
            </div>
            ...
            <div className="col-lg-4">
              <div className="don-box">
                ...
                <Link to="/RollerCoaster" className="btn1">
                  Know More
                </Link>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="don-box">
                ...
                <Link to="/DryGames" className="btn1">
                  Know More
                </Link>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="don-box">
                ...
                <Link to="/WaterGames" className="btn1">
                  Know More
                </Link>
              </div>
            </div>
      ...
      </section><section className="about-id" id="about">
        <div className="container">
          <div className="heading">
            <h2>About US</h2>
            <p>
      ...
      </section><section className="Instructions" id="instructions">
        <div className="container">
          <div className="heading">
